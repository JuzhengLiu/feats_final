...
DEFAULT_SRDAE_PATH = '/root/autodl-tmp/0-pipei-dinov3/outputs/sues_unsupervised_srdae_512/srdae_model_23_26_29.pth'
...
# MoE 配置 (Feature A)
MOE_CONFIG_PATH = '/root/autodl-tmp/0-pipei-dinov3/configs_sues/sues_train_moe.yml'
# 注意：这里需要指向您实际训练出的 MoE 权重文件，通常是 best_param.t 或指定 epoch 的权重
MOE_WEIGHT_PATH = '/root/autodl-tmp/0-pipei-dinov3/outputs/sues_train_moe/300_param.t'
